 var projects = [
     {"name": "AppsHoodie", "display" : true ,"description" : "An iOS application that allows the user to get coupons for the registered stores. Created the GUI that implements the core functionality of the app.", "technologies": "Swift, iOS, XCode"},
                 {"name": "Divvy App", "display" : true ,"description" : "A progressive web app that allow users to see the location if the Divvy stations within 3,5, or 10 miles radius the user’s current location.Displays a pie chart of the number of rides originated form the stations within the specified radius. The app uses the data from city if Chicago data portal.", "technologies": "HTML, JavaScript, CSS, Bootstrap, Google maps API, and Google charts API", "sourceCode": "https://github.com/bvajhi/IT202/tree/master/finalproject", "pageLink": "https://bvajhi.github.io/IT202/finalproject/"},
                 {"name": "Chicago Food Inspection", "display": false, "description" : "An interactive website that allows user to search the city of Chicago food inspection database, with repect to date, type, result, and zip.", "technologies": "AJAX, Responsive Design, Google maps API", "sourceCode" : "https://github.com/bvajhi/IT202/blob/master/project3/index.html", "pageLink":"https://bvajhi.github.io/IT202/project3"},{"name": "Battle Ship", "display" : true ,"description" : "A JAVA GUI project that allow users to play battle ship game online with another player. Allows user to create and connect to server.", "technologies": "Java, Intelli-J, Java Swing and AWT library, Java net library", "sourceCode": "https://github.com/bvajhi/battleShip"},
